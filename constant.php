...
if($_SERVER['HTTP_HOST'] == 'ds04.projectstatus.co.uk') {
    define('DB_NAME', 'imageviewer');
    define('DB_USER', 'imageviewer');
    define('DB_PASS', 'UBcDEQvHbaMBpsVb');
} else { //localhost
    define('DB_NAME', 'db_eonfx');
    define('DB_USER', 'root');
    define('DB_PASS', 'dots');
}
 ...
 * I personally think this should go into a language file. That would make it easier to built a multilingual app. For now it is here in english.
 */
